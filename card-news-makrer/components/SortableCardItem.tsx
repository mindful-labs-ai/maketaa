...
import type { Card, CardRole } from '@/lib/supabase';
    ...
    >
      ...
      <div className="flex items-start justify-between mb-2 gap-2">
        <div className="flex items-start gap-2 flex-1">
          {/* Drag Handle Icon */}
          <div {...attributes} {...listeners} className="pt-0.5 cursor-grab active:cursor-grabbing text-gray-400 hover:text-gray-600 flex-shrink-0">
        ...
        {/* Role Badge */}
        <span
          className={`text-xs font-medium px-2 py-1 rounded whitespace-nowrap flex-shrink-0 ${roleConfig.bg} ${roleConfig.text}`}
        >
          {roleConfig.label}
        </span>
      </div>
