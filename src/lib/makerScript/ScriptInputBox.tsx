      ...
      <main className='space-y-6'>
        ...
        <div className='space-y-2'>
          <Textarea
            ...
            className='min-h-[200px] resize-none text-base leading-relaxed border-[--border-default] text-[--text-primary] placeholder:text-[--text-tertiary] focus:border-[--accent] focus:ring-[--accent]/20 rounded-xl p-4'
          />
        ...
        <div className='flex justify-end'>
          <Button
            ...
            disabled={!isValid}
            className='h-12 px-8 text-base font-semibold rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 gap-2'
          >
            메이커로 이동
