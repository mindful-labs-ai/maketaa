...
import type { DesignTemplate } from '@/lib/card-news/types';
...
export const DARK_GREEN: DesignTemplate = {
  id: 'dark-green',
  name: '에디토리얼 그린',
  description: '다크 배경에 그린 액센트. 자연스럽고 편안한 느낌의 카드뉴스.',
  thumbnail: '/templates/dark-green-thumb.png',
  config: {
    background: {
      type: 'solid',
      color: '#2A2A2E',
