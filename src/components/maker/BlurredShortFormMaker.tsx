...
export const BlurredShortFormMaker = () => {
  return (
    <div className='min-h-screen blur-xs'>
      <header className='border-b border-[--border-default] top-0 z-10'>
            ...
            <div className='relative mt-4 h-fit overflow-hidden rounded-3xl border'>
              ...
              <div className='relative flex justify-between items-center p-4 md:p-6'>
                <div className='flex items-center gap-2'>
                  ...
                  <p className='hidden md:block text-xs text-[--text-secondary]'></p>
                </div>
                <Button variant='outline'>
                  <Settings />
                </Button>
      ...
      <footer className='border-t border-[--border-default] sticky bottom-0 z-10 mt-auto'>
        <div className='container mx-auto px-4 py-4'>
          <div className='flex items-center justify-between'>
            ...
            <div className='text-sm text-[--text-secondary] mr-8'></div>
          </div>
        </div>
      </footer>
    </div>
